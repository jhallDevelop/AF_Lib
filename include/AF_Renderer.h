...
AF_LIB_API af_bool_t AF_Renderer_Start(AF_RenderingData* _renderingData, AF_ECS* _ecs, uint16_t* _screenWidth, uint16_t* _screenHeight, const char* _projectRoot);
